  ...
  return (
    <section className="py-16 sm:py-20 bg-dark-secondary border-t border-dark-tertiary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-300 text-lg mb-8 leading-relaxed">{subheadline}</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          {showEmergency && (
            <a
              href="tel:8336382767"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border-2 border-emergency text-emergency hover:bg-emergency hover:text-white font-bold px-8 py-4 rounded transition-colors text-base min-h-[44px]"
            >
