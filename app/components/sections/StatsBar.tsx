...
export function StatsBar() {
  return (
    <section className="bg-dark-secondary border-y border-dark-tertiary py-8 sm:py-10">
          ...
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-2xl sm:text-3xl font-black text-white mb-1">{stat.number}</p>
