...
export const metadata: Metadata = {
  title: seo['/services/parts-supply']?.title,
  description: seo['/services/parts-supply']?.description,
}

export default function PartsSupplyPage() {
  const service = (servicesData as Service[]).find((s) => s.slug === 'parts-supply')!
